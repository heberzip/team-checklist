-- SEED SEGURO: limpia y repuebla con timestamps explícitos
BEGIN;

-- Si existen, vacía primero respetando FKs
TRUNCATE TABLE items, checklists RESTART IDENTITY CASCADE;
